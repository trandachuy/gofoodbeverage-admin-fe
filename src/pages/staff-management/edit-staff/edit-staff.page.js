...
export function EditStaff(props) {
  ...
  const loadDataToEditStaff = async (staffId, response) => {
    if (staffId) {
      ...
      form.setFieldsValue({
        ...
        groupPermissionBranches: [...staff?.permissionGroupControls],
      });
  ...
  const renderGroupPermissionAndBranch = () => {
    if (groupPermissionBranches && groupPermissions?.length > 0 && branches?.length > 0) {
              ...
              <Row className="group-permission-item" gutter={[22, 18]}>
                <Col xs={24} sm={24} lg={12}>
                  ...
                  <Form.Item
                    ...
                    rules={[
                      {
                        required: pageData.permission.selectGroup.required,
                ...
                <Col xs={24} sm={24} lg={12}>
                  ...
                  <Form.Item
                    ...
                    rules={[
                      {
                        required: pageData.permission.selectBranch.required,
